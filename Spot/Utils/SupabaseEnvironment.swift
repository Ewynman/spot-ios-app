...
//  Spot
//
//  Created for environment separation strategy
//
...
enum SupabaseConfiguration {
    ...
    static func load() -> (url: URL, anonKey: String, environment: SupabaseEnvironment) {
        ...
        if let plistConfig = loadFromPlist(), 
           !plistConfig.url.contains("PLACEHOLDER"),
        ...
        guard let url = URL(string: urlString),
            ...
            fatalError("""
                ...
                Either:
                1. Create a new production Supabase project and update SupabaseEnvironment.swift
